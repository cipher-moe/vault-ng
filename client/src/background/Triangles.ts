// https://github.com/zsxeee/TrianglesEffect/blob/9f20e02df0fe2e886379ad62048119eb920e27a0/src/Triangles.ts
const Triangles = (function () {
    ...
    return class Triangles {
        ...
        private baseColor: { h: number, s: number, l: number } = { h: 0, s: 0, l: 0 };
